            ...
            for cws in closeWords:
                ...
                if mot in cws.lemma_names():
                    ...
                    for w in cws.lemma_names():
                        thematiques[placementMot].append(w)
                        if(w == mot):
                         realThematiques[placementMot].append(motBrut)
        else:
            # Nouvelle thématique
            newRealThematique = []
            newThematique = []
...
if __name__ == '__main__':
    ...
    thematiques1.to_csv("visualisation/data/clean_thematiques2.csv")